  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-orbitron uppercase tracking-wider",
  {
    variants: {
      variant: {
        ...
        outline: "border border-primary bg-transparent text-primary hover:bg-primary/10 neon-border",
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary/80 purple-glow",
        ghost: "text-foreground hover:bg-muted hover:text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        neon: "bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground neon-border-intense transition-all duration-300",
        gold: "bg-accent text-accent-foreground hover:bg-accent/90 gold-glow",
      },
      size: {
